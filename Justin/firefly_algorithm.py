# -*- coding: utf-8 -*-
"""Firefly_modified.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yiokFtmnrmf83tAg_UdlxCb802QBHpQh
"""
...
def firefly_algorithm(fitness_function, population, dimensions, max_iter, alpha, beta, gamma):
	# Initialize the brightness of each firefly with a random value
	brightness = [random.uniform(0, 1) for _ in range(len(population))]
